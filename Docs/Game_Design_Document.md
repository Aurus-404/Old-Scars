...
| Combate, daño y armadura | Vulnerabilidad creíble, penetración explicable y arsenal con roles materiales claros. | Rifle, munición y aiming siguen siendo prototipos técnicos; M39 sólo expone `ApplyWound`. | M40.0 listo para autorización; M40.1 posterior. |
