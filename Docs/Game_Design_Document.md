...
| Combate, daño y armadura | Vulnerabilidad creíble, penetración explicable y arsenal con roles materiales claros. | M40.0 validó melee/firearm hacia M39. M40.1 validó cobertura regional equipped-only y un núcleo común de penetración residual para wearable armor/world surfaces con automatización y fresh-session manual. | `Combat Ready — APPROVED`. |
