...
| Save y persistencia | Preservar identidad y consecuencias actuales de forma segura. | Current Slice durable validado; tiempo, actores y estado médico se extienden aditivamente sobre V1. | M36.1–M39; ampliar sólo por milestone. |
| Salud y muerte | Vulnerabilidad, transición coherente a muerte/cuerpo y política de recuperación. | M39 implementa seis regiones, heridas durables, sangrado, dolor, venda localizada y muerte por reserva vital; validación manual pendiente. | Closeout M39 antes de combate. |
| Combate, daño y armadura | Vulnerabilidad creíble, penetración explicable y arsenal con roles materiales claros. | Rifle, munición y aiming siguen siendo prototipos técnicos; M39 sólo expone `ApplyWound`. | M40.0–M40.1; bloqueado por closeout M39. |
