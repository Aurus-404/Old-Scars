...
### M35.2.3: Inventory Window Redesign Phase C1 — IMPLEMENTED, PENDING UNITY VALIDATION

Estado: `implemented`; pendiente de validacion manual en Unity. M35.2 permanece `in progress` hasta esa validacion.
